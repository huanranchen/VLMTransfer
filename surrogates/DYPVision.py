...
__all__ = ["HuanranTransformerClipAttackVisionModel", "HuanranOpenClipAttackVisionModel"]


class HuanranTransformerClipAttackVisionModel(nn.Module):
    """
...
class HuanranOpenClipAttackVisionModel(nn.Module):
    """
    input an image, return a differentiable loss with respect to the original image
    """
